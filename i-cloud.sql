...
CREATE TABLE `t_view_rbac_resource` (
  `id` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '编号、主键',
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '名称',
  `type` int(11) NOT NULL COMMENT '类型[0:菜单,1:接口]',
  `path` varchar(1024) COLLATE utf8_unicode_ci NOT NULL COMMENT '路径',
  `parent_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0' COMMENT '父编号',
  ...
  `component_path` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '组件路径',
  `option_values_json` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '父层级',
  PRIMARY KEY (`id`)
...
CREATE TABLE `t_view_rbac_role` (
  `id` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '角色编号',
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '角色名称',
  `option_values_json` varchar(1024) COLLATE utf8_unicode_ci NOT NULL COMMENT '存在权限',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `t_view_rbac_role_resource` (
  `role_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '角色编号',
  `resource_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '资源编号'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `t_view_rbac_user` (
  `id` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '编号',
  ...
  `option_values_json` varchar(1024) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
('1','zhaotianyu','$2a$10$xXFoauday7avGjH13XYk4uUY35F2dqSSiiKEnbD53O9x/l3dtOozS','赵田雨','');
...
CREATE TABLE `t_view_rbac_user_role` (
  `user_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '用户编号',
  `role_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '角色编号'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
('1','b15e2535-4905-4cf6-81d8-22c5ff640840');
